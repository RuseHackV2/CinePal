            ...
            <div class="movie-facts">
                ...
                <div>
                    <?php if(isset($_SESSION['userid'])){
                      ?>
                        <a href="javascript:void(0)" class="btn btn-success btn-xs bookmark" data-id="<?=$movie['imdbID']?>"><?=isset($user)&&$user->bookmarked($movie['imdbID'])?'Remove bookmark':'Bookmark'?></a>
                        <?php
